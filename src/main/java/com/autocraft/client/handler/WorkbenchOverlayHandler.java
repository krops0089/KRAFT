 ...
 * выглядит как обычный верстак 3x3, значит это CraftingScreen).
 */
...
public class WorkbenchOverlayHandler {
    ...
    public static void onInitGui(GuiScreenEvent.InitGuiEvent event) {
        ...
        CraftingScreen workbench = (CraftingScreen) screen;
    ...
    private static void openSaveDialog(CraftingScreen workbench) {
